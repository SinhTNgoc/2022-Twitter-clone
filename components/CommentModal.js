      ...
      {open && (
        ...
        >
          <div className="p-1">
            ...
            <p className="ml-16 text-gray-500 text-[15px] sm:text-[16px]">{post?.data()?.text}</p>
            ...
            <div className="flex items-center justify-between py-2.5 mx-8 border-t border-gray-200">
              ...
              <button className="bg-blue-400 text-white font-bold shadow-md  px-4 py-1.5 rounded-full hover:brightness-95 disabled:opacity-50">
                Reply
              </button>
            </div>
          </div>
